...
; this is correct syntax for integrated assembler,
...
; 8086 assembler always initialises variables as 0
; For example:
...
; === [NOTE 7]   
; There can be syntax incompatibilities not mentioned here.
